...
from ldm.models.diffusion.ddim_test_model2 import DDIMSampler
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="path to config2 which constructs model2",
    )
    parser.add_argument(
        "--ckpt2",
        type=str,
        default="",
        help="path to checkpoint of model2",
    )
    parser.add_argument(
        "--seed",
        type=int,
    ...
    model.model2=model2
    model.proportionOFmodel1=opt.proportionOFmodel1
        ...
        with precision_scope("cuda"):
            with model.ema_scope():
                for iter, batch in enumerate(test_loader):
                    ...
                    # source_HF_2 = model.lap_pyr_c1.pyramid_decom(source_face_gray)[2]
                    # source_HF = source_HF_2

                    source_HF_0 = model.lap_pyr_c1.pyramid_decom(source_face_gray)[4]
                    source_HF = F.interpolate(source_HF_0, size=(64,64))
                    ...
                    source_HF = torch.cat([source_HF,source_depth_down4],dim=1)
                    source_HF2 = torch.cat([source_HF2,source_depth_down4],dim=1)
                    ...
                    test_model_kwargs['source_HF2'] = source_HF2.to(device)
